[<AutoOpen>]
module SongBook.Avalonia.Services
...
let configureServices () =
    ...
    services.AddSingleton<IPlatformService, PlatformService>() |> ignore
    services.AddSingleton<IProcessService, ProcessService>() |> ignore
    services.AddSingleton<ILinkOpeningService, LinkOpeningService>() |> ignore
